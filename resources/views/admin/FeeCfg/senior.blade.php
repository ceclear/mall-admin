...
{{--                                                <option value="">请选择范围</option>--}}
                                ...
                                <div class="form-group  ">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="input-group" style="margin-top: 10px;width: 50%">
                                            <input type="text" name="colonel_rate"
                                                   value="{{$info['rate_arr']['rates']['colonel_rate']}}"
                                                   class="form-control rate"
                                                   autocomplete="off"
                                                   placeholder="你团队无限级的所有团长,平台额外给你他团队收益（填数字，例 50）">
                                        </div>
                                        <div class="input-group" style="margin-top: 10px;width: 50%">
                                            <input type="text" name="senior_colonel_rate"
                                                   value="{{$info['rate_arr']['rates']['senior_colonel_rate']}}"
                                                   class="form-control rate"
                                                   autocomplete="off"
                                                   placeholder="你团队有人成为高级团长,平台额外给你他团队收益（填数字，例 50）">
                                        </div>
                                ...
                                <div class="form-group  ">
                                    ...
                                    <div class="col-sm-8" style="width: 80%">
                                        <div class="input-group">
                                            <label style="float:left;font-weight: 500; height: 30px; line-height: 37px;margin-left: 10px;">团队每出现一位高级团长，自购佣金提高</label>
                                            <input style="float: left;width: 60px;margin-left: 10px" type="text"
                                                   name="self_fee_rate_increment" value="{{$info['rate_arr']['rates']['senior_colonel_rate_step']['self_fee_rate_increment']}}"
                                                   class="form-control rate"
                                                   autocomplete="off" placeholder="数量">
                                            <label style="float:left;font-weight: 500; height: 30px; line-height: 37px;margin-left: 10px;">,</label>
                                            <input style="float: left;width: 60px;margin-left: 10px" type="text"
                                                   name="self_top" value="{{$info['rate_arr']['rates']['senior_colonel_rate_step']['self_top']}}"
                                                   class="form-control rate"
                                                   autocomplete="off" placeholder="数量">
                                            <label style="float:left;font-weight: 500; height: 30px; line-height: 37px;margin-left: 10px;">封顶。</label>
                                            <label style="float:left;font-weight: 500; height: 30px; line-height: 37px;margin-left: 10px;">团队佣金提高</label>
                                            <input style="float: left;width: 60px;margin-left: 10px" type="text"
                                                   name="team_fee_rate_increment" value="{{$info['rate_arr']['rates']['senior_colonel_rate_step']['team_fee_rate_increment']}}"
                                                   class="form-control rate"
                                                   autocomplete="off" placeholder="数量">
                                            <label style="float:left;font-weight: 500; height: 30px; line-height: 37px;margin-left: 10px;">,</label>
                                            <input style="float: left;width: 60px;margin-left: 10px" type="text"
                                                   name="team_top" value="{{$info['rate_arr']['rates']['senior_colonel_rate_step']['team_top']}}"
                                                   class="form-control rate"
                                                   autocomplete="off" placeholder="数量">
                                            <label style="float:left;font-weight: 500; height: 30px; line-height: 37px;margin-left: 10px;">封顶</label>
                                        </div>
                    ...
                    <div class="box-footer">
                        ...
                        <input type="hidden" name="type" value="{{$info['type']??3}}">
