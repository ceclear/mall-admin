    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form action="/admin/fee-cfg/partner-submit" id="post_form" method="post" accept-charset="UTF-8"
                                ...
                                <div class="form-group  ">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group" style="width: 50%;float:left">
                                            ...
                                            <input type="text" name="self_fee_rate" value="{{$info['self_fee_rate']}}" class="form-control rate"
                                                   autocomplete="off" placeholder="自己在平台领券购物获得的产品佣金（填数字，例 50）">
                                        </div>
                                        <div class="input-group" style="width: 50%;padding-left: 10px">
                                            <input type="text" name="subsidy_fee_rate" value="{{$info['subsidy_fee_rate']}}"
                                ...
                                <div class="form-group  ">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group" style="width: 50%">
                                            <input type="text" name="team_fee_one_rate" value="{{$info['team_fee_one_rate']}}"
                                                   class="form-control rate"
                                                   autocomplete="off" placeholder="你直接推荐的（一级合伙人）领券购物获得的佣金（填数字，例 50）">
                                        </div>
                                        <div class="input-group" style="margin-top: 10px;width: 50%">
                                            <input type="text" name="team_fee_two_rate" value="{{$info['team_fee_two_rate']}}"
                                                   class="form-control rate"
                                                   autocomplete="off"
                    ...
                    <div class="box-footer">
                        ...
                        <input type="hidden" name="type" value="{{$info['type']??1}}">
...
<script type="text/javascript">
    ...
    $(function () {
        $('#sub').click(function () {
            ...
            $.ajax({
                url: "/admin/fee-cfg/partner-submit",
                type: 'post',
                data: data,
                dataType: 'json',
                timeout: 10000,
